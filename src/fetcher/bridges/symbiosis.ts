...
export async function fetchSymbiosis(route: RouteKey, _key: string): Promise<NormalizedQuote[]> {
  try {
    ...
    const res = await fetchWithTimeout('https://api-v2.symbiosis.finance/crosschain/v1/swap', {
      method: 'POST',
